...
function App() {
  ...
  const [columnDefs] = useState([
    { field: "filename", headerName: "File Name", type: 'leftAligned', autoHeight: true, rowHeight: 100},
    { field: 'filetype', headerName: "File Type", type: 'leftAligned', autoHeight: true},
    { field: 'filesize', headerName: "File Size", type: 'leftAligned', autoHeight: true},
    { field: 'datestamp', headerName: "Date Uploaded", type: 'leftAligned', autoHeight: true},
    {field: 'handle',
    headerName: '' ,
